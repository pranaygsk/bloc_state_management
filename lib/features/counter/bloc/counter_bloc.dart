...
class CounterBloc extends Bloc<CounterEvent, CounterState> {
  ...
  FutureOr<void> counterNavigateToSecondPageEvent(CounterNavigateToSecondPageEvent event, Emitter<CounterState> emit) {
  ...
  FutureOr<void> counterResetEvent(CounterResetEvent event, Emitter<CounterState> emit) {
    count=0;
    emit(CounterResetActionState());
  }
}
